...
export abstract class Entity<EntityProps> {
  ...
  private validateProps(props: EntityProps): void {
    ...
    if (props === null || typeof props !== 'object' || Object.keys(props).length > maxProps) {
      throw new ArgumentOutOfRangeException(`Entity props should not be null or have more than ${maxProps} properties`);
    }
  }
}
